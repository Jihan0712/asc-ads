...
st.title("🎥 Automated Ad Compliance Checker (Zero Cost)")
st.write("Upload your Rules PDF and the Ad Media to run the compliance check using Gemini 2.0 Flash.")
...
if pdf_file and media_file:
    if st.button("Run AI Check", type="primary"):
        if not api_key:
            ...
            with st.spinner("Uploading files and analyzing with Gemini 2.0 Flash..."):
                try:
